...
class QuestionTest {
    ...
    void pprint() {
        ...
        String expected = "test: \n" +
                " - Having a shower: 1000wH X\n" +
                " - Dishwasher running for one hour: 1200wH O\n" +
                " - Having the computer turned on for one hour: 1100wH X\n" +
                " - Bake a cake: 800wH X\n";
        assertEquals(expected, question.pprint());
    }
