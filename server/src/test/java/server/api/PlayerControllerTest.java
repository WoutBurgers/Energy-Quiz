...
public class PlayerControllerTest {
    ...
    public void getAllPlayersTest() {
        assertEquals(ResponseEntity.ok(List.of(new Person("player1"))),
    ...
    public void getLeaderboard() throws Exception {
        assertEquals(List.of(p2, p1), myPlayerController.getLeaderboard(1L));
    }
    ...
    @Test
    public void add() {
        assertEquals(ResponseEntity.ok(p1), myPlayerController.add(p1.getUsername()));
    }

    @Test
    public void modify() {
        myPlayerController.modify(1, 2);
